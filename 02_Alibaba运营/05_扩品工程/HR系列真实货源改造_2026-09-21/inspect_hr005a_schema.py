"""Read-only HR005-A product/schema inventory for the planned 1882 migration."""
...
OUTPUT = Path(__file__).with_name("HR005-A_1882_schema_inventory.json")
PRODUCT_ID = 1601943335751
...
wanted_attribute_values = {
    "slip-on", "slip on", "mesh", "round toe", "mule", "mules", "slippers",
    "casual", "casual shoes", "men", "male", "china",
}
