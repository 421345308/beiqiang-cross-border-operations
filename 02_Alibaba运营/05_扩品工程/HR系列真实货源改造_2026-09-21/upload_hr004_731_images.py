"""Plan or upload the audited HR004 / 731 image set to Alibaba photobank.

Default mode is read-only and reports validation plus reuse decisions. Use
--apply only after the previous product gate is satisfied. The five company
template assets are reused by SHA-256 from the existing HR002 manifest.
"""
...
ASSET_ROOT = ROOT / "99_临时区" / "HR004_731"
...
RECEIPT = PROJECT / "HR004_731_图片银行映射.json"

FILES = [
    ("main", 1, GALLERY / "M1_HERO_731.jpg"),
    ("main", 2, GALLERY / "M2_COLORS_731.jpg"),
    ("main", 3, GALLERY / "M3_MESH_LACE_731.jpg"),
    ("main", 4, GALLERY / "M4_OUTSOLE_731.jpg"),
    ("main", 5, GALLERY / "M5_SIZE_731.jpg"),
    ("main", 6, GALLERY / "M6_FACTORY_PROCESS.jpg"),
    ("detail", 1, GALLERY / "D1_OVERVIEW_731.jpg"),
    ("detail", 2, GALLERY / "D2_GRAY_731.jpg"),
    ("detail", 3, GALLERY / "D3_BLACK_731.jpg"),
    ("detail", 4, GALLERY / "D4_ORDER_INPUTS_731.jpg"),
    ...
    ("sku", 1, SKU_DIR / "SKU_GREY_731.jpg"),
    ("sku", 2, SKU_DIR / "SKU_BLACK_731.jpg"),
]
...
def main():
    ...
    existing = load_json(RECEIPT, {"product_family": "HR004", "source_model": "731", "assets": []})
        ...
        if prior:
            rows.append({
                **item,
                ...
                "reused_from_family": "HR002" if prior not in existing.get("assets", []) else "HR004",
