#!/usr/bin/env python3
"""Repair only BQ018 expansion SKU color thumbnail bindings.

The protected A116 source product is never writable.  The three expansion
products keep their existing color names, SKU codes, 44 color/size SKUs,
title, six-image gallery, prices, attributes and details.  Default mode is a
read-only preflight; ``--apply`` is accepted only when a product is approved/Y.
"""
...
SOURCE_PRODUCT_ID = "10000044007878"
PRODUCTS = {
    "1601939726170": "BQ018-W1 / A116",
    "1601939641542": "BQ018-R1 / A116",
    "1601939589890": "BQ018-O1 / A116",
}
TARGET = {
    "-24": {
        "name": "Cream",
        "image_url": "https://sc04.alicdn.com/kf/S6c2add39ffa04564bffa92c22c639b7bC.jpg",
    },
    "-1": {
        "name": "Lavender",
        "image_url": "https://sc04.alicdn.com/kf/Saa8be4cb586e4eb6881fe0419b4378e0I.jpg",
    },
    "-80": {
        "name": "Black White",
        "image_url": "https://sc04.alicdn.com/kf/S616ed02bb2e9432a9ef8d7f39fa5a25f3.jpg",
    },
    "3327837": {
        "name": "Black",
        "image_url": "https://sc04.alicdn.com/kf/S783d5394ead14c42956e0eee6d570652U.jpg",
    },
}
...
def process(config: dict, product_id: str, expected_model: str, apply: bool) -> dict:
    ...
    if len(skus) != 44:
        raise RuntimeError(f"Expected 44 SKUs for {product_id}")
    ...
    checks = {
        ...
        "sku_count_44": len(after_skus) == 44,
