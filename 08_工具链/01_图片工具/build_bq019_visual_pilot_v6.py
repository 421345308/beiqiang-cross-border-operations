...
O=R/"02_Alibaba运营/02_单品优化记录/BQ系列持续优化_2026-09-14/BQ019_W1_整页视觉样板_v6_2026-09-16"
...
g=im(A/"PASS_M1_light_grey_hero.png"); b=im(A/"PASS_M2_light_grey_top.png"); c=im(A/"PASS_M3_light_grey_rear.png"); w=im(A/"HOLD_M4_light_grey_outsole_AI.png")
...
sq(A/"PASS_M2_light_grey_top.png",M/"M2_light_grey_top_view.jpg")
sq(A/"PASS_M3_light_grey_rear.png",M/"M3_light_grey_rear_view.jpg")
sq(A/"HOLD_M4_light_grey_outsole_AI.png",M/"M4_light_grey_outsole_HOLD.jpg")
...
pg=cv(DEEP); d=head(pg,"MULTI-ANGLE PROOF","ONE COLOR · DIFFERENT ANGLES","The same light-grey A206 is kept across every viewing role",True)
views=((b,"TOP / OPENING","Same light-grey shoe","contain"),(c,"REAR / HEEL","Same light-grey shoe","contain"),(w,"SOLE / SIDE","AI-reconstructed · verify tread","contain"))
...
pg=cv("#E8F2EE"); d=head(pg,"ORDER MATRIX","ALL COLORS IN ONE VIEW + SIZE RATIO","EU 35–45 · combinations confirmed for the actual order")
put(pg,im(RAW/"3.jpg"),(55,220,1090,590),focus=(.5,.52))
for i,(n,col) in enumerate((("BLACK","#171717"),("CREAM","#EDE5D3"),("LIGHT GREY","#AAB2B1"),("WHITE","#FFFFFF"))):
 x=55+i*272; card(d,(x,835,x+245,925)); d.ellipse((x+20,854,x+70,904),fill=col,outline="#AAB8B3",width=2); tx(d,(x+88,879),n,16,INK,True,"lm")
card(d,(55,955,1145,1090),"#FAFCFB"); tx(d,(85,980),"BUYER INPUT",18,GRN,True); tx(d,(85,1020),"EU 35×__  36×__  37×__  ...  45×__",21,INK,True); tx(d,(85,1060),"Confirm color mix and pairs by size.",17,MUT)
...
contacts(mp,P/"01_main_gallery_v6.jpg",3,400); contacts(dp,P/"02_product_detail_v6.jpg",2,500); contacts(cp,P/"03_company_detail_v6.jpg",3,400)
(O/"README.md").write_text("""# BQ019-W1 整页视觉样板 v6
